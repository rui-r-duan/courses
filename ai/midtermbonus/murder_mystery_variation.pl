...
% variation:
%
% in order to test the affection of the rule untrustworthy(sam) in this program
%
% 1. excuse(sam, monday, john) is changed to excuse(sam, friday, john).
% 2. Added one recedent to has_excuse(...) which requires the person who has
%    excusse to be a trustworthy person.
%
%
